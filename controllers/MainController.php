        ...
        if (isset($this->getArray['pageID'])) { //check if a page id is contained in the URL
            switch ($this->getArray['pageID']) {
                ...
                case "shop":
                    ...
                    $student = new shop($this->user, $this->postArray, $this->pageTitle, "", $this->db, strtoupper($this->getArray['pageID']));
                ...
                case "shopkart":
                    //create objects to generate view content
                    //($loggedin,$postArray,$pageTitle,$pageHead,$database)
                    $student = new Shoppingkart($this->user, $this->postArray, $this->pageTitle, strtoupper($this->getArray['pageID']), $this->db);
                    $navigation = new Navigation($this->user, $this->getArray['pageID']);
                    array_push($this->controllerObjects, $student, $navigation);
                ...
                case "storage":
                    ...
                    //create objects to generate view content
                    //($loggedin,$postArray,$pageTitle,$pageHead,$database)
                    $student = new storage($this->user, $this->postArray, $this->pageTitle, strtoupper($this->getArray['pageID']), $this->db);
                    $navigation = new Navigation($this->user, $this->getArray['pageID']);
                    array_push($this->controllerObjects, $student, $navigation);
